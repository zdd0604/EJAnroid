...
public class BusinessBaseDao extends BaseDao {
     ...
     * @param where
     */
    public static final void insertCtlm1108(String[] where) {
        SQLiteDatabase database = beginDMLOnTransaction();
        try {
            StringBuffer sb = new StringBuffer();
            sb.append("insert into ").append(Tables.BusinessCtlm1108.NAME).append(" ( ")
                    .append(Tables.BusinessCtlm1108.COL_ID_CLERK).append(" , ")
                    .append(Tables.BusinessCtlm1108.COL_SGIN_TIME).append(" , ")
                    .append(Tables.BusinessCtlm1108.COL_SGIN_TIME_UP).append(" , ")
                    .append(Tables.BusinessCtlm1108.COL_SGIN_TIME_down)
                    .append(") values ('")

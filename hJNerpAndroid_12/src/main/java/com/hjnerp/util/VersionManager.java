...
public class VersionManager
{
	...
	public final void checkVersionUpgrade(final Context context, OnUpgradeResultListener l)
	{
		this.l = l;
	...
	public final void showNotNewDialog(final Context context)
	{

...
public class FastArrayList extends ArrayList {
     ...
     *  of this list
     */
    public FastArrayList(Collection<Object> collection) {
    ...
    public boolean add(Object element) {
        ...
        if (fast) {
            synchronized (this) {
                ArrayList<Object> temp = (ArrayList<Object>) list.clone();
    ...
    public boolean equals(Object o) {
        ...
        if (fast) {
            ListIterator<Object> li1 = list.listIterator();
    ...
    private class SubList implements List {
        ...
        private List<Object> get(List<Object> l) {
            if (list != expected) {
        ...
        public List<Object> subList(int f, int l) {
            if (list != expected) {
                throw new ConcurrentModificationException();
            }

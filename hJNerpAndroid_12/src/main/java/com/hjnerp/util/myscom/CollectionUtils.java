...
public class CollectionUtils {
    ...
    public static void transform(Collection<Object> collection, Transformer transformer) {
        if (collection != null && transformer != null) {
            if (collection instanceof List) {
                ...
                Collection<Object> resultCollection = collect(collection, transformer);
                collection.clear();
     ...
     */
    public static Collection<Object> select(Collection inputCollection, Predicate predicate) {
        ArrayList<Object> answer = new ArrayList<Object>(inputCollection.size());
     ...
     */
    public static void select(Collection inputCollection, Predicate predicate, Collection<Object> outputCollection) {
        if (inputCollection != null && predicate != null) {
     ...
     * @throws NullPointerException if the input collection is null
     */
    public static Collection<Object> selectRejected(Collection inputCollection, Predicate predicate) {
        ArrayList<Object> answer = new ArrayList<Object>(inputCollection.size());
     ...
     * @param outputCollection  the collection to output into, may not be null
     */
    public static void selectRejected(Collection inputCollection, Predicate predicate, Collection<Object> outputCollection) {
        if (inputCollection != null && predicate != null) {
            for (Iterator iter = inputCollection.iterator(); iter.hasNext();) {
                Object item = iter.next();
     ...
     * @throws NullPointerException if the input collection is null
     */
    public static Collection<Object> collect(Collection<Object> inputCollection, Transformer transformer) {
        ArrayList<Object> answer = new ArrayList<Object>(inputCollection.size());
     ...
     * @return the transformed result (new list)
     */
    public static Collection<Object> collect(Iterator<Object> inputIterator, Transformer transformer) {
     ...
     */
    public static Collection<Object> collect(Collection<Object> inputCollection, final Transformer transformer, final Collection<Object> outputCollection) {
     ...
     * @throws NullPointerException if the output collection is null
     */
    public static Collection<Object> collect(Iterator<Object> inputIterator, final Transformer transformer, final Collection<Object> outputCollection) {
     ...
     */
    public static boolean addIgnoreNull(Collection<Object> collection, Object object) {
     ...
     * @since Commons Collections 3.2
     */
    public static Collection<Object> retainAll(Collection collection, Collection retain) {
     ...
     * @since Commons Collections 3.2
     */
    public static Collection<Object> removeAll(Collection collection, Collection remove) {

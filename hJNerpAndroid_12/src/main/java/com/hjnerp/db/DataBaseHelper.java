...
public class DataBaseHelper extends SQLiteHelper {
    ...
    private String[] tableList = new String[]{
            Tables.ConfigTable.NAME,
            Tables.WorkFlowList.NAME,
            Tables.BusinessMenu.NAME,
            Tables.BusinessCtlm4203.NAME,
            Tables.BusinessCtlm1108.NAME,
            Tables.BusinessCtlm1345.NAME,
            Tables.BusinessCtlm1346.NAME,
            Tables.BusinessCtlm1347.NAME,
            Tables.UserTable.NAME,
            Tables.ContactTable.NAME,
            Tables.EnterpriseInfoTable.NAME,
            Tables.GroupInfoTable.NAME,
            Tables.GroupRelationTable.NAME,
            Tables.TempContactTable.NAME
    };
